...
- [x] Confirm all twelve planners use 12:00 AM, 8:00 AM, and 4:00 PM from `.sys/black-hole/jules-schedules.json`.
- [x] Confirm all twelve executors use 1:00 AM, 9:00 AM, and 5:00 PM and the same role's execution prompt.
